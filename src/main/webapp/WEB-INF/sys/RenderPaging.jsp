...
<div class="slpager">
    ...
    <input id="txtCurrentPage" title="当前页" type="text" value="1" style="width: 60px; text-align: center;" />/
    <input readonly="readonly" id="txtMaxPage" title="总页数" type="text" value="1" style="width: 60px; background-color: #EEEEEE; text-align: center;" />
    <a id="btnDownPage" title="下一页"><b>&gt;</b></a>&nbsp;<a id="btnEndPage" title="尾页"><b>&gt;|</b></a>
    <select id="txtPageSize" style="height: 25px;" title="每页行数">
...
<script type="text/javascript">
    ...
    //var search;
    //function GetSearch(channSearch) {
